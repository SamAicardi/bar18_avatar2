...
#==============================================
#     Move the examples to /home/vagrant
#==============================================
cd /vagrant
...
# fixup keystone's installation path (c.f. https://github.com/keystone-engine/keystone/issues/235)
...
#==============================================
#     Download and unpack, or build firefox
